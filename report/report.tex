...
\begin{itemize}
  \item \textbf{Pass rate}: fraction of trials that produce a correct formula.
...
[3] introduced the HumanEval benchmark for evaluating LLM code generation. Our work applies a similar evaluation framework to a formal specification language rather than a general-purpose programming language.
